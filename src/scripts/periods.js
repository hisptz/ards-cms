...
function preparePeriods(first_period) {
  ...
  for (var i = 0; i < 10; i++) {
    ...
    if ($.inArray(year + "01", first_period) != -1) {
      ...
      monthList += '<option value="' + year + '03">March ' + year + "</option>";
      monthList += '<option value="' + year + '04">April ' + year + "</option>";
      monthList += '<option value="' + year + '05">May ' + year + "</option>";
      monthList += '<option value="' + year + '06">June ' + year + "</option>";
      monthList += '<option value="' + year + '07">July ' + year + "</option>";
      monthList +=
