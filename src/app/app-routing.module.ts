...
const routes: Routes = [
  ...
  {path: 'home-page-menus', loadChildren: 'app/home-menus/home-menus.module#HomeMenusModule'},
  {path: 'information-sharing', loadChildren: 'app/info-sharing/info-sharing.module#InfoSharingModule'},
