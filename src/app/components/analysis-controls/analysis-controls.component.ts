...
import * as fromAnalysisService from "../../providers/organisation-unit.service";
import * as _ from "lodash";
@Component({
  selector: "analysis-controls",
  templateUrl: "./analysis-controls.component.html",
  styleUrls: ["./analysis-controls.component.css"]
})
export class AnalysisControlsComponent {
  ...
  preparePeriodFilter(first_period) {
    ...
    $("#years").trigger("click");
    const clickEvent = $("#years").trigger("click");
    console.log("weClick", clickEvent);
  }
